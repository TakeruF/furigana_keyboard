...
export const copy = {
  ja: {
    ...
    download: { heading: "あなたの端末へ。", intro: "各ストアでの公開後、このページから直接アクセスできます。", beta: "ベータ版", androidTitle: "Android版", androidBody: "オフライン手書き認識、ふりがな表示、連続入力に対応。", apk: "APKをダウンロード", iosTitle: "iOS版", iosBody: "現在プレビュー開発中。端末内の単文字認識と読み表示から対応。", appStore: "App Storeで見る", pending: "準備中", pendingLabel: "現在準備中です" },
  ...
  zh: {
    ...
    download: { heading: "安装到你的设备。", intro: "应用正式发布后，可从本页面直接前往下载。", beta: "测试版", androidTitle: "Android 版", androidBody: "支持离线手写识别、注音显示和连续输入。", apk: "下载 APK", iosTitle: "iOS 版", iosBody: "目前处于预览开发阶段，MVP 支持设备端单字识别和读音显示。", appStore: "前往 App Store", pending: "准备中", pendingLabel: "目前正在准备中" },
  ...
  ko: {
    ...
    download: { heading: "내 기기에서 시작하세요.", intro: "각 스토어에 공개되면 이 페이지에서 바로 이동할 수 있습니다.", beta: "베타 버전", androidTitle: "Android 버전", androidBody: "오프라인 필기 인식, 후리가나 표시, 연속 입력을 지원합니다.", apk: "APK 다운로드", iosTitle: "iOS 버전", iosBody: "현재 프리뷰 개발 중이며 MVP는 기기 내 한 글자 인식과 읽기 표시를 지원합니다.", appStore: "App Store에서 보기", pending: "준비 중", pendingLabel: "현재 준비 중입니다" },
