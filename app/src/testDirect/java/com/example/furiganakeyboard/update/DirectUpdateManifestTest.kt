    ...
    fun parsesValidManifest() {
        val manifest = DirectUpdateManifest.parse(
            """
            {
              "versionCode": 12,
              "versionName": "1.2.0",
              "downloadUrl": "https://downloads.takeruf.com/furigana-keyboard/1.2.0.apk",
    ...
    fun acceptsManifestWithoutReleaseNotes() {
        val manifest = DirectUpdateManifest.parse(
            """
            {
              "versionCode": 2,
              "versionName": "1.1",
              "downloadUrl": "https://downloads.takeruf.com/furigana-keyboard/1.1.apk",
    ...
    fun rejectsNonHttpsDownload() {
        DirectUpdateManifest.parse(
            """
            {
              "versionCode": 2,
              "versionName": "1.1",
              "downloadUrl": "http://downloads.takeruf.com/furigana-keyboard/1.1.apk",
    ...
    fun rejectsApkOutsideDistributionDirectory() {
        DirectUpdateManifest.parse(
            """
            {
              "versionCode": 2,
              "versionName": "1.1",
              "downloadUrl": "https://downloads.takeruf.com/1.1.apk",
